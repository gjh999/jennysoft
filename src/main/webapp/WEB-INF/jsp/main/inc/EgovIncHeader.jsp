            ...
            <div class="all_menu">
                <div class="inner">
                    <div>
                        <h2>사이트소개</h2>
                        <ul>
                            <li><a href="/EgovPageLink.do?linkIndex=3">사이트소개</a></li>
                            <li><a href="/EgovPageLink.do?linkIndex=4">연혁</a></li>
                            <li><a href="/EgovPageLink.do?linkIndex=5">조직소개</a></li>
                            <li><a href="/EgovPageLink.do?linkIndex=6">찾아오시는 길</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        <h2>민원광장</h2>
                        <ul>
                            <li><a href="/EgovPageLink.do?linkIndex=1">민원신청</a></li>
                            <li><a href="/EgovPageLink.do?linkIndex=2">민원결과확인</a></li>
                        </ul>
                    </div>
